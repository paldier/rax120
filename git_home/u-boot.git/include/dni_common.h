...
#if defined(WORKAROUND_IPQ807X_GMAC_NMRP_HANG)
#define workaround_ipq807x_gmac_nmrp_hang_action()  do {  \
	DECLARE_GLOBAL_DATA_PTR;  \
	eth_halt();  \
	eth_init();  \
} while (0)
#else
#define workaround_ipq807x_gmac_nmrp_hang_action()  do {} while (0)
#endif
