...
version_string="$0 v0.1.2-ipq807x.ilq.8.0-spf.8.0"
...
(
    cd "$work_dir"
    rm -rf BOOT.AK.1.0 BOOT.BF.3.1.1 IPQ4019.ILQ.8.0 IPQ8064.ILQ.8.0 RPM.AK.1.0 TZ.AK.1.0 TZ.BF.2.7 TZ.BF.2.10 NHSS.QSDK.7.0 WLAN.BL.3.4 WLAN.HK.1.0.2
    cp -rf */* .
)
