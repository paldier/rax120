...
int checkboard(void)
{
    printf("U-boot dni1 V1.1 for DNI HW ID: 29765589; NAND flash 256MB; RAM 1024MB .\n");
	printf("developed based on 'qsdk-ipq807x.ilq.8.0-spf.8.0.FCu2' \n");
    return 0;
}
#endif
...
int board_match_image_hw_id (ulong fw_image_addr)
{
	...
	/* Only check first 29 chars hw29765589p0p256p1024p4x4p8x8 */
