		       ...
		       struct ip_options *opt, struct sk_buff *skb)
{
	...
	for (l = opt->optlen; l > 0; ) {
		...
		*  1.1 Basic NAT
		*    2. For IP options Record Route (7), Strict Source Route (9), and Loose Sou    rce Route (3),
		*  an implementation SHOULD let the options pass through without changing anyth    ing.
		*/
	   ...
	   /*
		* Reset the values, so `ip_options_rcv_srr` and `ip_forward_options` will NOT p    rocess it;
