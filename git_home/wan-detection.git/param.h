...
#if 1
#define DEF_L2TP_NETMASK	"255.255.255.255"
#define DEF_L2TP_IPADDR	"10.0.0.140"
#define DEF_L2TP_SERVER	"10.0.0.138"
#else
#define DEF_L2TP_NETMASK	"255.255.254.0"
#define DEF_L2TP_IPADDR		"172.17.144.109"
#define DEF_L2TP_SERVER		"172.17.145.45"
#endif
