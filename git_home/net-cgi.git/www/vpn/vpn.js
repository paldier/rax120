function handle_on_updating() {
	...
	if(on_updating == "1") {
		if(!!document.getElementById("for_windows")) {
			document.getElementById("for_windows").className = "window1_bt";
			document.getElementById("for_windows").disabled = true;
		}
		if(!!document.getElementById("for_non_windows")) {
			document.getElementById("for_non_windows").className = "non_window1_bt";
			document.getElementById("for_non_windows").disabled = true;
		}
		if(!!document.getElementById("for_smart_phone")) {
			document.getElementById("for_smart_phone").className = "non_window1_bt";
			document.getElementById("for_smart_phone").disabled = true;
		}
		if(!!cf.Apply && master == "admin") {
		...
		if(!!document.getElementById("for_windows")) {
			...
			document.getElementById("for_windows").disabled = false;
		}
		if(!!document.getElementById("for_non_windows")) {
			document.getElementById("for_non_windows").className = "non_window_bt";
			document.getElementById("for_non_windows").disabled = false;
		}
		if(!!document.getElementById("for_smart_phone")) {
			document.getElementById("for_smart_phone").className = "non_window_bt";
			document.getElementById("for_smart_phone").disabled = false;
		}
		if(!!cf.Apply && master == "admin") {
