...
function check_acc_add(cf,flag)
{
	...
	if(flag=='edit_allow')
	{
		...
		cf.hidden_allow_or_block.value = convert_value_to_original(cf, "allow_or_block");
		if(cf.hidden_allow_or_block.value == "Blocked")
	...
	if(flag=='edit_block')
	{
		...
		cf.hidden_allow_or_block.value = convert_value_to_original(cf, "allow_or_block");
		if(cf.hidden_allow_or_block.value == "Allowed")
