...
function basic_menu_class_default()
{
	...
	*/
	...
	if(getTop(window).enable_ap_flag== 1 || getTop(window).enable_bridge_flag== 1)
	...
	if( getTop(window).funjsq_flag==1 && (getTop(window).enable_ap_flag== 1 || getTop(window).enable_bridge_flag== 1 || getTop(window).enable_extender_flag == "1") && getTop(window).gui_region=="Chinese" && getTop(window).netgear_region=="PR")
...
function click_action(id)
{
		...
		else if( id == "3g" && getTop(window).have_broadband ==1 && getTop(window).broadband_mode != "AutoDetc" )
		{
			...
			if( endis_wl_radio == '1' || endis_wla_radio == '1' || (getTop(window).tri_router_flag == '1' && endis_wla_2nd_radio == '1'))
                ...
                {
			if(getTop(window).have_dynamic_qos == 1 || getTop(window).use_orbi_style_flag == 1)
			{
		...
		else if( id == "intqos" && getTop(window).have_dynamic_qos == 1 && getTop(window).enable_ap_flag != 1 && getTop(window).enable_bridge_flag == 0 && getTop(window).enable_extender_flag == "0" && getTop(window).device_mode != "1" )
		{
			...
			if(!IsGameRouter()&&top.trend_micro_qos == "1") {
                        ...
                        else if(getTop(window).have_advanced_qos == "1")
				goto_formframe("QOS_wait.htm");
			else if(getTop(window).trend_micro_flag == "1") {
				please_wait(false);
				getTop(window).formframe.location.href = "new_waiting_page.htm";
			}
			else
		...
		else if( id == "no_internet" && getTop(window).enabled_wds == 0 && getTop(window).enable_ap_flag != 1 && getTop(window).broadband_mode != "MyDetc" && getTop(window).enable_bridge_flag == 0 && getTop(window).enable_extender_flag == "0" && getTop(window).device_mode != "1")
		{
			if(getTop(window).have_broadband==1 && (getTop(window).is_ru_version==1 || getTop(window).is_pr_version==1))
			{
				open_or_close_sub('internet');
		...
		else if( id == "funjsq" && getTop(window).enable_ap_flag != 1 && getTop(window).enable_bridge_flag == 0 && getTop(window).enable_extender_flag == "0" )
                {
		...
		else if( id == "vpn_client" && getTop(window).vpn_client_flag == "1" && getTop(window).enable_ap_flag != 1 && getTop(window).enable_bridge_flag == 0)
		{
