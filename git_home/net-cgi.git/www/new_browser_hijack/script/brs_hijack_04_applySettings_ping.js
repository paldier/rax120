...
function loadValue()
{
   if(getTop(window).dsl_enable_flag == 0){
	...
	else if(getTop(window).support_orange_flag ==1  || getTop(window).support_singapore_isp_flag == 1 || getTop(window).support_malaysia_isp_flag == 1 || getTop(window).support_spain_isp_flag == 1 || getTop(window).support_malaysia_pppoe_isp_flag == 1 ){
		if(select_basic == "0" && (select_type == "6" || select_type == "7" || select_type == "8" || select_type == "9" || select_type == "10" || select_type == "11" || select_type == "12" || select_type == "13" || select_type == "14" || select_type == "15"))
		{
			if(ping_result == "success")
