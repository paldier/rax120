...
var security_enhance_flag= "<% security_enhance_support() %>"
	if(security_enhance_flag == "1")
		document.write('<TITLE>$password_reset</TITLE>');
	else
		document.write('<TITLE>$router_password_recovery</TITLE>');
</script>
<META http-equiv=content-type content='text/html; charset=UTF-8'>
<LINK rel="stylesheet" href="/style/form.css">
<STYLE type="text/css">
TR{ FONT-FAMILY: Arial;}
html, body{ margin: 0; border:none; background-color:#120203;background-image: url('/desktop/testwallpaper.svg'); background-attachment: fixed; background-size: cover; background-repeat: no-repeat; width:100%; height:100%}
</STYLE>
<script>
...
<TR>
        ...
        <script>
			if(answer_again == "1")
				document.write('<input type="text" maxLength="64" autocomplete="off" size="30" name="answer1" id="answer1" value="'+last_error_ans1+'" onFocus="this.select();" >');
			else
				document.write('<input type="text" maxLength="64" autocomplete="off" size="30" name="answer1" id="answer1" onFocus="this.select();" >');
		</script>
        </TD>
</TR>
<TR>
...
<TR>
		...
		<script>
			if(answer_again == "1")
				document.write('<input type="text" maxLength="64" autocomplete="off" size="30" name="answer2" id="answer2" value="'+last_error_ans2+'" onFocus="this.select();" >');
			else
				document.write('<input type="text" maxLength="64" autocomplete="off" size="30" name="answer2" id="answer2" onFocus="this.select();" >');
		</script>
</TD>
</TR>
...
<input class="apply_bt" type="submit" name="continue" id="continue" value=" $continue_mark "></p>
</TD></TR>
</TABLE>
</form>
</div>
