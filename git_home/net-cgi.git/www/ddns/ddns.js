function click_ddns(form)
{
	...
	var sysDNSProviderlist_value=convert_value_to_original(form, "sysDNSProviderlist");
	if (form.sysDNSActive.checked)
		form.ddns_enabled.value = "1";
	else
		form.ddns_enabled.value = "0";

	if(ddns_wildcards_flag==1 && sysDNSProviderlist_value == "www/var/www.3322.org")
	{
	...
	if (form.sysDNSActive.checked)
	{
		if(form.sysDNSHost.value=="" && sysDNSProviderlist_value != "www/var/www.oray.cn")
		{
			alert("$hostname_null");
			return false;
		}
		...
		if(sysDNSProviderlist_value != "www/var/www.oray.cn")//hostname
		{
		...
		if(sysDNSProviderlist_value == "www/var/www.oray.cn")//username
		{
		...
		if((sysDNSProviderlist_value == 'www/var/www.DynDNS.org' && form.hidden_pwd_change_1.value == "1") ||
		 (sysDNSProviderlist_value == 'www/var/www.oray.cn' && form.hidden_pwd_change_2.value == "1") ||
		 (sysDNSProviderlist_value == 'www/var/www.3322.org' && form.hidden_pwd_change_3.value == "1") ||
		 (sysDNSProviderlist_value == 'www/var/dynupdate.no-ip.com' && form.hidden_pwd_change_4.value == "1"))
			password_change=1;
		if ((new_sysDNSHost == form.sysDNSHost.value) && (new_sysDNSUser == form.sysDNSUser.value) && password_change == 0 && (old_endis_wildcards == form.wildcards_enabled.value) && (old_endis_ddns == form.ddns_enabled.value) && (dns_list == sysDNSProviderlist_value))
		{
	...
	if((dns_list != sysDNSProviderlist_value || (dns_list == sysDNSProviderlist_value && old_sysDNSHost != form.sysDNSHost.value)) && vpn_enable == "1" && form.sysDNSActive.checked == true)
...
function change_ddns_password(obj)
{
	...
	var sysDNSProviderlist_value=convert_value_to_original(cf, "sysDNSProviderlist");
	...
	if( sysDNSProviderlist_value == 'www/var/www.DynDNS.org' )
		cf.hidden_pwd_change_1.value="1";
	else if( sysDNSProviderlist_value == 'www/var/www.oray.cn')
		cf.hidden_pwd_change_2.value="1";
	else if( sysDNSProviderlist_value == 'www/var/www.3322.org' )
		cf.hidden_pwd_change_3.value="1";
	else if( sysDNSProviderlist_value == 'www/var/dynupdate.no-ip.com' )
