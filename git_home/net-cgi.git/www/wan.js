function checkwan()
{
	...
	cf.hid_iptv_mask.value=parseInt(cf.hid_bri_lan1.value)+parseInt(cf.hid_bri_lan2.value*2)+parseInt(cf.hid_bri_lan3.value*4)+parseInt(cf.hid_bri_lan4.value*8)+parseInt(bri_lan_tag5*16)+parseInt(bri_lan_tag6*32);
	...
	if (cf.disable_dos.checked == false)
