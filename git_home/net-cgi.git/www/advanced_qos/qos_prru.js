	...
	//	document.getElementById("qos_modes").style.color="black";
		...
		//{
			...
			{	
				...
				cf.Add.className = "new_apply_bt ui-corner-all button-sty1";
				cf.Reset.disabled = false;
				cf.Reset.className = "new_apply_bt2 ui-corner-all button-sty1";

				cf.Edit.disabled = false;
				cf.Edit.className = "new_apply_bt ui-corner-all button-sty1";
				cf.Deleteone.disabled = false;
				cf.Deleteone.className = "new_apply_bt ui-corner-all button-sty1";
				cf.DeleteAll.disabled = false;
				cf.DeleteAll.className = "new_apply_bt2 ui-corner-all button-sty1";
			}
	/*	}
		else
		{
