...
*/
	...
	*/
	if(support_samba_flag == 1)
	{
		if(form.enable_samba_v1.checked)
			form.hid_samba_v1.value = "1";
		if(form.enable_samba_v2.checked)
			form.hid_samba_v2.value = "1";
		if(form.enable_samba_v3.checked)
			form.hid_samba_v3.value = "1";
	}
