...
function genieHelpChecking()
{
	...
	else if((top.support_orange_flag == 1 || top.support_singapore_isp_flag == 1 || top.support_malaysia_isp_flag == 1 || top.support_spain_isp_flag == 1 || top.support_malaysia_pppoe_isp_flag == 1)&& choices[3].checked)
	{
