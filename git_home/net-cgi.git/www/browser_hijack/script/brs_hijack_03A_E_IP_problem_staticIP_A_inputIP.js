...
function checkStaticIP()
{
	...
	cf.preferred_dns.value = address_parseInt(cf.preferred_dns.value);
	cf.alternate_dns.value = address_parseInt(cf.alternate_dns.value);
	cf.third_dns.value = address_parseInt(cf.third_dns.value);
	cf.submit();
