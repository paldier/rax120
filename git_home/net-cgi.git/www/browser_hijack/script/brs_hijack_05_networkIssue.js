...
function clickNext()
{
	...
	else if(choices[1].checked)
	{
		...
		top.click_no_flag=1;
		if(top.support_orange_flag ==1 || top.support_singapore_isp_flag == 1 || top.support_malaysia_isp_flag == 1 || top.support_spain_isp_flag == 1 || top.support_malaysia_pppoe_isp_flag == 1){
		       	if(internet_type == "0" && (internet_ppp_type == "6" || internet_ppp_type == "7" || internet_ppp_type == "8" || internet_ppp_type == "9" || internet_ppp_type == "10"|| internet_ppp_type == "11"|| internet_ppp_type == "12" || internet_ppp_type == "13"|| internet_ppp_type == "14" || internet_ppp_type == "15")) {
