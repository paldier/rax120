...
#define PPPOE_SESSION_LOAD     "/usr/share/ppp/ppp-session.script pppoe_ses_load 0"
#define PPPOE_SESSION_RESET     "/usr/share/ppp/ppp-session.script pppoe_ses_reset 0"
#define PPPOE_SESSION_SET       "/usr/share/ppp/ppp-session.script pppoe_ses_set 0"

#define PPPOE1_SESSION_LOAD     "/usr/share/ppp/ppp-session.script pppoe_ses_load 1"
#define PPPOE1_SESSION_RESET     "/usr/share/ppp/ppp-session.script pppoe_ses_reset 1"
#define PPPOE1_SESSION_SET       "/usr/share/ppp/ppp-session.script pppoe_ses_set 1"
