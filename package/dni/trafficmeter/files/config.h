...
#define WAN_PPP_STATUS "/etc/ppp/ppp0-status"
...
/* support traffic usage for GUI 3.0 */
/* #define SUPPORT_DATAUSAGE */
#ifdef SUPPORT_DATAUSAGE
#define TMP_TRAFFIC_DATAUSAGE "/tmp/trafficmeter_datausage"
#endif
